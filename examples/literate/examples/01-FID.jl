...
#md savefig(p2, "../../assets/FOLDER_NAME/1-signal.html") # hide
#jl display(p2)

#md # ```@raw html
#md # <object type="text/html" data="../../../assets/FOLDER_NAME/1-signal.html" style="width:100%; height:320px;"></object>
#md # ```
...
#md savefig(p3, "../../assets/FOLDER_NAME/1-signal2.html") # hide
#jl display(p3)

#md # ```@raw html
#md # <object type="text/html" data="../../../assets/FOLDER_NAME/1-signal2.html" style="width:100%; height:320px;"></object>
#md # ```
