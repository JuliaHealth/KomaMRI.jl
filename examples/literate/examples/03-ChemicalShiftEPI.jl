...
#md savefig(p1, "../../assets/FOLDER_NAME/2-phantom1.html") # hide
#md savefig(p2, "../../assets/FOLDER_NAME/2-phantom2.html") # hide
#jl display(p1)
#jl display(p2)
...
#md # ```@raw html
#md # <object type="text/html" data="../../../assets/FOLDER_NAME/2-phantom1.html" style="width:50%; height:420px;"></object><object type="text/html" data="../../../assets/FOLDER_NAME/2-phantom2.html" style="width:50%; height:420px;"></object>
#md # ```
...
#md savefig(p3, "../../assets/FOLDER_NAME/2-seq.html") # hide
#jl display(p3)

#md # Feel free to explore the sequence's plot 🔍 below!

#md # ```@raw html
#md # <object type="text/html" data="../../../assets/FOLDER_NAME/2-seq.html" style="width:100%; height:320px;"></object>
#md # ```
...
#md savefig(p4, "../../assets/FOLDER_NAME/2-signal.html") # hide
#jl display(p4)

#md # ```@raw html
#md # <object type="text/html" data="../../../assets/FOLDER_NAME/2-signal.html" style="width:100%; height:320px;"></object>
#md # ```
...
#md savefig(p5, "../../assets/FOLDER_NAME/2-recon.html") # hide
#jl display(p5)

#md # ```@raw html
#md # <center><object type="text/html" data="../../../assets/FOLDER_NAME/2-recon.html" style="width:65%; height:420px;"></object></center>
#md # ```
