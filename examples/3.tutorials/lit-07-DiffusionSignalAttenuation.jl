...
# For this, we are going to define a [`KomaMRI.path`](@ref) motion to simulate the Brownian motion of spins.
...
# Now we will define the Brownian motion of the spins using the [`KomaMRI.path`](@ref) motion definition.
