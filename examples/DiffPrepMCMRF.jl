...
dwell_time = 6.4e-6
Gmax = 62e-3 # mT/m
Smaxs = [70, 100] # mT/m/ms
axis_to_calc = ["x", "y", "z", "xyz"] # ["x", "y", "z", "xyz", "xz", "yz"] 
...
for k = moment_to_calc #Number of moments to null
    ...
    for axis = axis_to_calc
        ...
        ## TO SCANNER
        path_res = "C:/Users/carlo/Desktop/DPW/G$(floor(Int,Gmax*1e3))_SR$(ceil(Int,Smax))_$axis/"
