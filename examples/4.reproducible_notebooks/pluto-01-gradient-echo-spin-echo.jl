...
begin
	sys = Scanner()
	durRF = π/2/(2π*γ*sys.limits.B1); #90-degree hard excitation pulse
	rf = PulseDesigner.RF_hard(sys.limits.B1, durRF, sys)
end
...
begin
	...
	signal_t2_star_se = plot_signal(raw_t2_star_se; slider=false, height=400)
