...
- Preserve the paper links listed in `docs/paper-links.toml`: when changing one of their destinations, update its mapping and verify the generated redirect in `docs/build/1`.
