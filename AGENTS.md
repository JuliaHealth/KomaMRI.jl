...
- Never accept Julia/Pkg interactive prompts that add packages or compat entries to `Project.toml`. Abort the prompt and activate the correct project instead.
