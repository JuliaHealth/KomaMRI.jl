...
global PACKAGES_PATH::String = normpath(joinpath(@__DIR__, "..", "packages"))
global BUNDLES_PATH::String = normpath(joinpath(@__DIR__, "bundles"))
...
global CORE_BUNDLE_PATH::String = joinpath(BUNDLES_PATH, "webio.bundle.js")
...
global GENERIC_HTTP_BUNDLE_PATH::String = joinpath(BUNDLES_PATH, "generic-http.bundle.js")
...
global MUX_BUNDLE_PATH::String = joinpath(BUNDLES_PATH, "mux.bundle.js")
...
global BLINK_BUNDLE_PATH::String = joinpath(BUNDLES_PATH, "blink.bundle.js")
