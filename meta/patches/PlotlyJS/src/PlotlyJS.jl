...
global _pkg_root = dirname(dirname(@__FILE__))
global _js_path = joinpath(artifact"plotly-artifacts", "plotly.min.js")
global _js_version = include(joinpath(_pkg_root, "deps", "plotly_cdn_version.jl"))
...
function __init__()
    ...
    global _pkg_root = joinpath(dirname(Base.pkgdir(WebIO)), "PlotlyJS") # A dirty hack
    global _js_path = joinpath(artifact"plotly-artifacts", "plotly.min.js")
