...
@testitem "Bloch_RF_accuracy" begin
    using Suppressor
    include("initialize_backend.jl")
...
@testitem "Bloch_phase_compensation" begin
    using Suppressor
    include("initialize_backend.jl")
...
@testitem "simulate_slice_profile" begin
    using Suppressor
    include("initialize_backend.jl")
