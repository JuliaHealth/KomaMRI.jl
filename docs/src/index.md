...
```@raw html
<p align="center"><img class="docs-light-only" width="100%" :src="$withBase('/assets/koma-schema.svg')"/></p>
<p align="center"><img class="docs-dark-only"  width="100%" :src="$withBase('/assets/koma-schema-dark.svg')"/></p>
```
